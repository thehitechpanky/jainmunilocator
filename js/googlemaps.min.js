...
var marker, i;
	...
	for (i = 0; i < locations.length; i++) {
		...
		marker = new google.maps.Marker({
			...
			//var content=locations[i][3]+locations[i][0];
		google.maps.event.addListener(marker, 'click', (function(marker, i) {
			return function() {
				infowindow.setContent(locations[i][0]+'ADDRESS:-'+locations[i][3]);
...
//               addx = address;
//               $.when(wait(dtd,address)).done(function () { alert(g); }).fail(function () { alert("fail！"); });
//
//           }
