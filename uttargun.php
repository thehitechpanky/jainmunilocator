...
<body onunload="" <?php echo $schemaOrgBody; ?>>
	...
	<div class="content page-content">
		...
		<div class="page-title">
			<h1>Thirty Four Extra Virtues (Uttar Gun)</h1>
		</div>
		...
		<div class="">
			...
			<div>
				...
				<h2><u>TWENTY TWO PARISHA JAI (Victories of pinches)</u></h2><br />
				<img class="floatRight" title="Five Mahavrat" width="300" src="https://jainsquare.files.wordpress.com/2011/03/680px-mahavratas.jpg" />
				<ol>
					<li>
						<h3>SHUDHA JAI</h3>
						To bear hunger keeping normal thoughts.
					</li><br /><li>
						<h3>PIPASA JAI</h3>
						To bear thirst without uneasiness.
					</li><br /><li>
						<h3>SHEET JAI</h3>
						...
						<h3>DANSH MASAK JAi</h3>
						To keep normal if mosquito etc. bite.
					</li><br /><li>
						<h3>NAGAN PARISH JAI</h3>
