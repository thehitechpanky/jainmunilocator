...
<html lang="en">
	...
	<head>
		...
		<title>Tirthankara | Jain Muni Locator</title>
	...
	<body id="home" itemscope itemtype="http://schema.org/WebPage">
		...
		<!-- Navigation -->
		<?php
$navLinks = '<li><a href="#about">Tirthankara list</a></li>
		...
		<section id="about" class="about content-section alt-bg-light wow fadeInUp" data-wow-offset="10">
			<div class="container">
				<div class="row">
					<h1>Tirthankara</h1>
					<div class="col-md-6">
						<input id="search" type="text" class="fullWidth" placeholder="Search by typing here... Click on any name below to know more...">
...
include 'scripts.php';
		...
		<script type="text/javascript" src="tirthankara/search.js"></script>
