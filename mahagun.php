...
<body onunload="" <?php echo $schemaOrgBody; ?>>
	...
	<div class="content page-content">
		...
		<div class="page-title">
			<h1>Twenty Eight Special Virtues (महागुण)</h1>
		</div>
		...
		<div class="">
			<div>
				Digambar Jain Sadhus take a vow to observe Twenty Eight Special Virtues (महागुण) at the time of their induction into the saintly order and remain vigilant to observe these without slightest deviation through out their life.
			</div>
			<div>
				These twenty eight special virtues have been divided into Five Great Vows (पंच-महाव्रत), Five Limits / Care (पंच-समिति), Victory over Five Senses (पंच-इन्द्रिय-विजय), Six Essential Duties (षट्-आवश्यक) and Seven Specialties (सप्त विशेष गुण).
			</div><br /><br />
			
			<!-- Start List Items -->
			<div>
				
				<h2><u>Five Special Vows (पंच-महाव्रत)</u></h2><br />
				<img class="floatRight" title="Five Mahavrat" width="300" src="https://jainsquare.files.wordpress.com/2011/03/680px-mahavratas.jpg" />
				<ol>
					<li>
						<h3>Vow of Non Violence (अहिंसा-व्रत)</h3>
						...
						<h3>Vow to Never Steal (अचौर्य-व्रत)</h3>
						...
						<h3>Vow of Bramcharya (भ्रमचर्य-व्रत)</h3>
						...
						<h3>Vow of Renunciation (अपरिग्रह-व्रत)</h3>
				...
				<h2><u>Seven Specialities (सप्त विशेष गुण)</u></h2><br />
				<img class="floatRight" title="Five Mahavrat" width="300" src="https://jainsquare.files.wordpress.com/2011/03/680px-mahavratas.jpg" />
				<ol>
					<li>
						<h3>ACHAILAKTAV (NAKEDNESS)</h3>
			...
			<div id="fb-root"></div>
			<div class="fb-like" data-href="http://jainmunilocator.org/mahagun.php" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div>
			<div class="fb-comments" data-href="http://jainmunilocator.org/mahagun.php" data-numposts="5"></div>
