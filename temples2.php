...
<html lang="en">
	...
	<head>
		...
		<title>Digambara Jain Temples</title>
			...
			<div class="carousel-inner">
				<div class="item active">
					...
					<div class="carousel-caption">
						<h1 class="wow animated slideInDown">Taking your business to <span class="highlight">new heights</span></h1>
						<p class="intro-text wow animated slideInUp">Halloou is designed and aimed at creative teams that want to showcase their products and services in a new, creative way.</p>
				...
				<div class="item">
					...
					<div class="carousel-caption">
						...
						<p class="intro-text wow animated slideInUp">Halloou gives you the freedom to easily change the color of the whole template to match your brand, re-arrange blocks to suit your needs.</p>
						<a href="http://bit.ly/hh5_template" class="btn btn-default btn-lg">Download theme</a>
					</div>
					<div class="overlay-detail"></div>
				</div><!-- /.item -->
			...
			<div class="container">
				<div class="row text-center">
					<div class="col-md-6 wow slideInLeft" data-wow-offset="10">
						<h2>Halloou is a creative HTML5 template</h2>
